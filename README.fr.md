...
<br>La **Phase 1 (Cadrage)** traduit les compétences à démontrer en exigences fonctionnelles précises et traçables.
<br>La **Phase 2 (Modélisation des données)** construit, à partir de ces exigences, un schéma en étoile normalisé compatible SQLite et Azure SQL Database.
<br>La **Phase 3 (Architecture technique)** définit l'infrastructure de collecte, de stockage et d'ingestion des données. 
<br>La **Phase 4 (ETL et contrôle qualité)** met en œuvre les règles de validation, la détection des valeurs aberrantes par IQR et Z-score, et le calcul de l'indice composite de qualité.
<br>La **Phase 5 (Indicateurs de pilotage)** formalise les KPIs de couverture, de vélocité et de qualité. 
<br>La **Phase 6 (Visualisation Power BI)** restitue l'ensemble sous forme de tableau de bord interactif à trois niveaux de lecture.
<br>La **Phase 7 (Automatisation et alertes)** introduit des mécanismes de notification et un score de risque par unité. 
<br>la **Phase 8 (Documentation et gouvernance)** consolide le dictionnaire de données, le journal des décisions méthodologiques et la documentation technique du projet.
